...
$path_temp = str_replace('/cms/ckeditor/filemanager/core', '', dirname(__FILE__));
$path_temp = str_replace('\cms\ckeditor\filemanager\core', '', $path_temp);
define('PATH_SELF',  $path_temp);

require(PATH_SELF.'/cms/includes/head.conf.php');
