...
app.directive('repeatTreeCategories', ['$parse', '$log', function($parse, $log) {
'use strict';
  ...
  function repeatTreeLink (scope, element, attrs, ctrl, transclude) {
    ...
    expression = attrs.repeatTreeCategories;
      ...
      function repeatTreeRecursive(obj, level = 0){
        ...
        angular.forEach(obj, function(value, index){
          ...
          if(value.name){
            ...
            //var beforeElement = angular.element('<td class="before-level-' + level + '"></td>').append(before);
